...
const Demo = () => {
  ...
  useEffect(() => {
    const articlesFormLocalStorage = JSON.parse(localStorage.getItem('articles'));
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='relative flex justify-center items-center'>
      ...
      <img src={linkIcon} alt="linkicon" className='absolute left-0 my-2 ml-2 w-5'/>
      ...
      <button type='submit' className='submit_btn p-2 peer-focus:border-gray-700 peer-focus:text-gray-700'>
